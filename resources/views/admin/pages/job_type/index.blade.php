                ...
                <div class="page-header-content d-lg-flex">
                    <div class="d-flex">
                        <h4 class="page-title mb-0">
                            Dashboard - <span class="fw-normal">Job Type</span>
                        </h4>
                        <a href="#page_header"
            ...
            <div class="content">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title">Job Type List</h5>
                        <div class="card-tools text-end"
                            style="display: flex; align-items:center; justify-content: space-between;">
                            <div class="btns">
                                <a href="#" class="text-white btn btn-primary" data-toggle="modal" data-target="#users">Add Type</a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('admin.job-type.save')}}" method="post">
                    @csrf
                    <div class="form-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="name" class="form-control" name="name" required placeholder="Enter Job Type">
                                </div>
                            </div>

                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Job Type value :</label>
                                    <input type="text" id="value" class="form-control" name="value" required placeholder="Enter Job Type Value">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Job Type :</label>
                                    <input type="text" id="rolename" class="form-control" name="name" required placeholder="Enter Type">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Job Type value :</label>
                                    <input type="text" id="rolevalue" class="form-control" name="value" required placeholder="Enter Type Value">
                                </div>
                            </div>
                        </div>
                        <div class="form-seperator-dashed"></div>
                    ...
                    if (selectedIds.length > 0) {
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                $.ajax({
                                    url: "{{ route('job-type.deletemulti') }}",
                                    method: 'DELETE',
...
<script>
    function editRole(element){
        ...
        var roleName = $(element).data('job_type');
        var roleValue = $(element).data('type_value');
